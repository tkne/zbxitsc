# Disk IO status check for Zabbix agent on Ubuntu 16.04 (Xenial Xerus)
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Ubuntu1604/Shell%20Script/diskio_install.sh | bash
```
