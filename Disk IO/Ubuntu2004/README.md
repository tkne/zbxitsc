# Disk IO status check for Zabbix agent on Ubuntu 20.04 (Focal Fossa)
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Ubuntu2004/Shell%20Script/diskio_install.sh | bash
```
