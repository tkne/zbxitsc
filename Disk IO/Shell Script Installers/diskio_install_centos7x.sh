#!/bin/sh
# This script will install Disk IO status check settings on a Cent OS 7.X server.

# Download Disk IO config file for Zabbix agent
wget https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Configs/iostat.conf -O /etc/zabbix/zabbix_agentd.d/iostat.conf
