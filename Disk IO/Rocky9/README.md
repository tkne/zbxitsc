Disk IO status check for Zabbix agent on Rocky Linux 9 (Blue Onyx)
======
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Rocky9/Shell%20Script/diskio_install.sh | bash
```
