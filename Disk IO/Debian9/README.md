# Disk IO status check for Zabbix agent on Debian 9 (Stretch)
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Debian9/Shell%20Script/diskio_install.sh | bash
```
