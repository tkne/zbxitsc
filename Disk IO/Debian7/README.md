Disk IO status check for Zabbix agent on Debian 7 (Wheezy)
======
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Debian7/Shell%20Script/diskio_install.sh | bash
```
