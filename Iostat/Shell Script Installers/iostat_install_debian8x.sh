#!/bin/sh
# This script will install iostat settings on a Debian OS 8.X server.
...
wget https://raw.githubusercontent.com/tkne/zbxitsc/master/Iostat/Config/iostat-params.conf -O /etc/zabbix/zabbix_agentd.conf.d/iostat-params.conf
