iptables status check for Zabbix agent on Debian 11 (Bullseye)
======
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Debian11/Shell%20Script/iptablescheck_install.sh | bash
```
