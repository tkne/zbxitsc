iptables status check for Zabbix agent on Ubuntu 14.04 (Trusty Tahr)
======
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Ubuntu1404/Shell%20Script/iptablescheck_install.sh | bash
```
