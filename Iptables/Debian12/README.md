iptables status check for Zabbix agent on Debian 12 (Bookworm)
======
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Debian12/Shell%20Script/iptablescheck_install.sh | bash
```
