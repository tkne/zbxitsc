iptables status check for Zabbix agent on Ubuntu 18.04 (Bionic Beaver)
======
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Ubuntu1804/Shell%20Script/iptablescheck_install.sh | bash
```
