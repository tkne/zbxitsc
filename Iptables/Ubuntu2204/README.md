iptables status check for Zabbix agent on Ubuntu 22.04 (Jammy Jellyfish)
======
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/Ubuntu2204/Shell%20Script/iptablescheck_install.sh | bash
```
