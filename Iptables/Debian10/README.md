# iptables status check for Zabbix agent on Debian 10 (Buster)
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Iptables/Debian10/Shell%20Script/iptablescheck_install.sh | bash
```
