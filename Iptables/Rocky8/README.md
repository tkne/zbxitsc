# iptables status check for Zabbix agent on Rocky Linux 8 (Green Obsidian)
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Iptables/Rocky8/Shell%20Script/iptablescheck_install.sh | bash
```
