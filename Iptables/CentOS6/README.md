iptables status check for Zabbix agent on CentOS 6
======
...
```bash
wget -O - https://raw.githubusercontent.com/tkne/zbxitsc/master/Disk%20IO/CentOS6/Shell%20Script/iptablescheck_install.sh | bash
```
